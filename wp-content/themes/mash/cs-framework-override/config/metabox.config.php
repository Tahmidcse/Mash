...
// -----------------------------------------
// Custom post Metabox Options(Pricing)                    -
// -----------------------------------------
$options[]    = array(
  'id'        => 'custom_post_pricing_options',
    ...
    array(
      ...
      'fields' => array(
        ...
        array(
          'type' => 'group',
          'id' => 'pricing_features',
          'title' => 'Feature of Pricing',
          'button_title' => 'Add New Feature',
          'fields' => array(
            array(
              'type' => 'text',
              'id' => 'feature_title',
              'title' => 'Please write your feature here',
                ),
...
// -----------------------------------------
// Custom post Metabox Options(Team Member)                    -
// -----------------------------------------
$options[]    = array(
  'id'        => 'custom_post_team_member_options',
    ...
    array(
      ...
      'fields' => array(
        ...
        array(
          ...
          'type'  => 'text',
          'title' => 'Designation Of Team Member',
        ...
        array(
          ...
          'title' => 'Social Icon Of Team Member',
          'button_title' => 'Add New Social Icon',
          'fields' => array(
            array(
              'type' => 'icon',
              'id' => 'team_icon',
              'title' => 'Please select your social icon.',
                ),
                array(
                  'type' => 'text',
                  'id' => 'team_URL',
                  'title' => 'Please link your social icon URL.',
                    ),
